...
var toUrlKey = function(url) {
    ...
    while ( i-- ) {
        ...
        // https://github.com/uGuardAdmin/uGuard/issues/301
...
// https://github.com/uGuardAdmin/uGuard/issues/362
//
...
var load = function() {
    ...
    µBlock.assets.get('assets/uguard/mirror-candidates.txt', onMirrorCandidatesReady);
};
