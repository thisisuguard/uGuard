/*******************************************************************************
    ...
    uGuard - a browser extension to block requests.
...
return {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/180
    ...
    projectServerRoot: 'https://raw.githubusercontent.com/uGuard-LLC/uGuard/master/',
    donationUrl: 'http://uguard.prv.pl/',
    ...
    permanentLists: {
        ...
        // uGuard
        'assets/uguard/filters.txt': {
            title: 'uGuard filters',
            group: 'default'
        },
        'assets/uguard/privacy.txt': {
            title: 'uGuard filters – Privacy',
            group: 'default'
        }
    },
