...
// https://github.com/uGuardAdmin/uGuard/issues/996
...
// https://github.com/uGuardAdmin/httpswitchboard/issues/345
...
var updateFirewallCell = function(scope, des, type, rule) {
    ...
    if ( aCount !== 0 || bCount !== 0 ) {
        // https://github.com/uGuardAdmin/uGuard/issues/471
...
var renderPopup = function() {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/470
    // This must be done here, to be sure the popup is resized properly
    var dfPaneVisible = popupData.dfEnabled && popupData.advancedUserEnabled;

    // https://github.com/uGuardAdmin/uGuard/issues/1068
...
var setFirewallRule = function(src, des, type, action, persist) {
    // This can happen on pages where uGuard does not work
...
var reloadTab = function() {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/748
