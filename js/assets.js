...
var exports = {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/426
...
var cachedAssetsManager = (function() {
    ...
    var getEntries = function(callback) {
        ...
        // https://github.com/uGuardAdmin/httpswitchboard/issues/212
        ...
        var onLoaded = function(bin) {
            // https://github.com/uGuardAdmin/httpswitchboard/issues/381
    ...
    exports.removeAll = function(callback) {
        var onEntries = function() {
            ...
            exports.remove(/^assets\/(uguard|thirdparties)\//);
...
var getTextFileFromURL = function(url, onLoad, onError) {
    ...
    // https://github.com/uGuardAdmin/uMatrix/issues/15
...
var getRepoMetadata = function(callback) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/515
...
var readRepoFile = function(path, callback) {
    ...
    var onRepoFileLoaded = function() {
        ...
        // https://github.com/uGuardAdmin/httpswitchboard/issues/263
        if ( this.status === 200 ) {
            reportBack(this.responseText);
        } else {
    ...
    // 'uguard=...' is to skip browser cache
    getTextFileFromURL(
        repositoryURL + '?uguard=' + Date.now(),
        onRepoFileLoaded,
        onRepoFileError
    );
};
...
//       Path --> starts with 'assets/(thirdparties|uguard)/', with a home URL
//   External -->
...
var readRepoCopyAsset = function(path, callback) {
    ...
    var repositoryURL = projectRepositoryRoot + path;
    var repositoryURLSkipCache = repositoryURL + '?uguard=' + Date.now();
...
//       Path --> starts with 'assets/(thirdparties|uguard)/', without a home URL
...
var readRepoOnlyAsset = function(path, callback) {
    ...
    var repositoryURL = projectRepositoryRoot + path + '?uguard=' + Date.now();
...
var readExternalAsset = function(path, callback) {
    ...
    var onExternalFileLoaded = function() {
        // https://github.com/uGuardAdmin/uGuard/issues/708
...
exports.metadata = function(callback) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/186
