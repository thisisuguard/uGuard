...
var onMessage = function(request, sender, callback) {
    ...
    switch ( request.what ) {
        case 'getAssetContent':
            // https://github.com/uGuardAdmin/uGuard/issues/417
    ...
    switch ( request.what ) {
        case 'getPopupData':
            ...
            vAPI.tabs.get(request.tabId, function(tab) {
                // https://github.com/uGuardAdmin/uGuard/issues/1012
...
var onMessage = function(request, sender, callback) {
    ...
    switch ( request.what ) {
        ...
        case 'setSessionFirewallRules':
            // https://github.com/uGuardAdmin/uGuard/issues/772
...
var restoreUserData = function(request) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/1102
