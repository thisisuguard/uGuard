...
µBlock.staticNetFilteringEngine = (function(){
    ...
    var strToRegex = function(s, anchor) {
        // https://github.com/uGuardAdmin/uGuard/issues/1038
   ...
   var FilterDomain = function(offsets, hostnameOnlyFilter) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/235
    ...
    //
    // FilterHostnameDict is the main reason why uGuard is not equipped to keep
    ...
    // counter-filter.
    //
    // On the other hand it is also *one* of the reason uGuard's memory and CPU
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/589
    ...
    FilterParser.prototype.parse = function(raw) {
        ...
        if ( s.lastIndexOf('||', 0) === 0 ) {
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/1096
            if ( s.charAt(0) === '^' ) {
                this.unsupported = true;
                return this;
            }
    ...
    FilterContainer.prototype.compile = function(raw, out) {
        ...
        // https://github.com/uGuardAdmin/uGuard/issues/665
    ...
    FilterContainer.prototype.tokenize = function(url) {
        ...
        while ( matches = re.exec(url) ) {
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/1118
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/116
    ...
    FilterContainer.prototype.matchString = function(context) {
        // https://github.com/uGuardAdmin/uGuard/issues/519
        ...
        // https://github.com/uGuardAdmin/httpswitchboard/issues/239
