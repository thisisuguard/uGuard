...
var cosmeticFilterFromElement = function(elem, out) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/637
...
var elementsFromFilter = function(filter) {
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/945
...
var onSvgClicked = function(ev) {
    // https://github.com/uGuardAdmin/uGuard/issues/810#issuecomment-74600694
...
// https://github.com/uGuardAdmin/uGuard/issues/190
...
var startPicker = function(details) {
    ...
    if (details.target) {
        if (details.target.type === 'element') {
            ...
            console.error('uGuard> unknown element picker target details type: %s', details.target.type);
        }
    } else {
