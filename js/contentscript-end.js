/*******************************************************************************
    ...
    Home: https://github.com/uGuardAdmin/uGuard
*/
...
// https://github.com/uGuardAdmin/uGuard/issues/464
...
// https://github.com/uGuardAdmin/uGuard/issues/587
// Pointless to execute without the start script having done its job.
if ( !vAPI.contentscriptStartInjected ) {
    return;
}

// https://github.com/uGuardAdmin/uGuard/issues/456
// Already injected?
...
vAPI.proceduralCosmeticFiltering = (function() {
    ...
    proceduralSelector.prototype = {
        parseProcedure : function(expression, prefix = "") {
            ...
            if(matches[1] == "properties") {
                ...
                console.error(new SyntaxError("Failed to parse uGuard."));
                return null;
            }
    ...
    var hideElements = function(selectors) {
      // https://github.com/uGuardAdmin/uGuard/issues/207
      ...
      // https://github.com/uGuardAdmin/uGuard/issues/158
...
// https://github.com/uGuardAdmin/uGuard/issues/789
...
// https://github.com/uGuardAdmin/uGuard/issues/7

var uGuardCollapser = (function() {
    var timer = null;
    var requestId = 1;
    var newRequests = [];
    var pendingRequests = {};
    ...
    var onProcessed = function(response) {
        ...
        while ( i-- ) {
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/869
            if ( !request.collapse ) {
                continue;
            }
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/399
            // Never remove elements from the DOM, just hide them
            target.style.setProperty('display', 'none', 'important');

            // https://github.com/uGuardAdmin/uGuard/issues/1048
    ...
    var add = function(target) {
        ...
        // https://github.com/uGuardAdmin/uGuard/issues/174
    ...
    var addIFrame = function(iframe, dontObserve) {
        // https://github.com/gorhill/uGuard/issues/162
...
(function() {
    ...
    var retrieveGenericSelectors = function() {
        if ( lowGenericSelectors.length !== 0 || highGenerics === null ) {
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/452
    ...
    var nextRetrieveHandler = function(response) {
        ...
        //console.debug('%f: uGuard: CSS injection time', timer.now() - tStart);
    };
    ...
    //console.debug('%f: uGuard: survey time', timer.now() - tStart);
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/618
    ...
    // https://github.com/uGuardAdmin/uGuard/issues/205
    ...
    // https://github.com/uGuardAdmin/httpswitchboard/issues/176
...
(function() {
    var onResourceFailed = function(ev) {
        ...
        uGuardCollapser.add(ev.target);
        uGuardCollapser.process();
    };
