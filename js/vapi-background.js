...
// https://github.com/gorhill/uGuard/issues/101
...
// https://github.com/uGuardAdmin/uGuard/issues/19
...
CallbackWrapper.prototype.proxy = function(response) {
    // https://github.com/uGuardAdmin/uGuard/issues/383
...
vAPI.net.registerListeners = function() {
    ...
    var normalizeRequestDetails = function(details) {
        ...
        // https://github.com/uGuardAdmin/uGuard/issues/862
...
// the web pages before uGuard was ready.
...
vAPI.onLoadAllCompleted = function() {
    ...
    var bindToTabs = function(tabs) {
        ...
        while ( i-- ) {
            ...
            // https://github.com/uGuardAdmin/uGuard/issues/129
            scriptStart(tab.id);
        }
    };
